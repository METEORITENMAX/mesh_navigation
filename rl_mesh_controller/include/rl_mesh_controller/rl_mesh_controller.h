...
{
class RLMeshController : public mbf_mesh_core::MeshController
{
public:

  //! shared pointer typedef to simplify pointer access of the mesh controller
  typedef std::shared_ptr<rl_mesh_controller::RLMeshController> Ptr;
  ...
  std::vector<geometry_msgs::msg::PoseStamped> calculateLookahead(const std::vector<geometry_msgs::msg::PoseStamped>& plan,
...
#endif /* MESH_NAVIGATION__RL_MESH_CONTROLLER_H */